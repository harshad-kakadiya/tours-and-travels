...
// Section Component
const Section = ({ title, children, defaultOpen = true, disabled = false }) => {
    ...
    return (
        <div className="border border-border rounded-xl overflow-hidden bg-card/80 backdrop-blur shadow-sm">
            ...
            >
                ...
                {/* onClick functionality commented out for disabled sections */}
                {/* <Icon name={open ? 'ChevronUp' : 'ChevronDown'} size={18} className="text-muted-foreground" /> */}
                {!disabled && <Icon name={open ? 'ChevronUp' : 'ChevronDown'} size={18} className="text-muted-foreground" />}
            </button>
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <section className="hidden md:block">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-center mt-4">
            ...
            <section className="pt-16 pb-12">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        {/* Package selector - always visible, no toggle functionality */}
                        <div className="border border-border rounded-xl overflow-hidden bg-card/80 backdrop-blur shadow-sm">
                            <div className="px-5 py-4 bg-gradient-to-r from-muted/40 to-background">
                                <div className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                                    <span className="font-semibold text-foreground">Select Package</span>
                                </div>
                            </div>
                            <div className="p-5">
                        ...
                        {/* Date picker - always visible, no toggle functionality */}
                        <div className="border border-border rounded-xl overflow-hidden bg-card/80 backdrop-blur shadow-sm">
                            <div className="px-5 py-4 bg-gradient-to-r from-muted/40 to-background">
                                <div className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                                ...
                                {selectedDate && (
                                    <div
                                        ...
                                        <span className="text-sm font-medium text-foreground">
                                            Selected Date: <span
                                            className="text-primary">{formatDateForDisplay(selectedDate)}</span>
                                        </span>
                                    </div>
                                )}
                            </div>
                        ...
                        {/* Sharing type - always visible, no toggle functionality */}
                        <div className="border border-border rounded-xl overflow-hidden bg-card/80 backdrop-blur shadow-sm">
                            <div className="px-5 py-4 bg-gradient-to-r from-muted/40 to-background">
                                <div className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                                    <span className="font-semibold text-foreground">Select Sharing Type</span>
                                </div>
                            </div>
                            <div className="p-5">
                        ...
                        {/* Schedule - always visible, no toggle functionality */}
                        <div className="border border-border rounded-xl overflow-hidden bg-card/80 backdrop-blur shadow-sm">
                            <div className="px-5 py-4 bg-gradient-to-r from-muted/40 to-background">
                                <div className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                    ...
                    <div className="lg:col-span-1">
                        <div className="lg:sticky lg:top-24 space-y-4">
                            <div className="border border-border rounded-2xl p-6 bg-card/90 backdrop-blur shadow-md">
                                    ...
                                    {(() => {
                                        ...
                                        return (
                                            <span className="flex items-center gap-2">
                                                <span
                                                    className="text-2xl font-bold text-foreground">₹{discounted.toLocaleString()}</span>
                                                {hasDiscount && (
                                                    <span
                                ...
                                <Button onClick={handleWhatsAppBooking} fullWidth
                            ...
                            {/* Highlights section - always visible, no toggle functionality */}
                            <div className="border border-border rounded-xl overflow-hidden bg-card/80 backdrop-blur shadow-sm">
                                <div className="px-5 py-4 bg-gradient-to-r from-muted/40 to-background">
                                    <div className="flex items-center gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                            ...
                            {/* Good to know - always visible, no toggle functionality */}
                            <div className="border border-border rounded-xl overflow-hidden bg-card/80 backdrop-blur shadow-sm">
                                <div className="px-5 py-4 bg-gradient-to-r from-muted/40 to-background">
                                    <div className="flex items-center gap-3">
                                        <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                ...
                <div className="mt-12 container mx-auto px-4 sm:px-6 lg:px-8">
                    <h3 className="text-[24px] font-heading font-semibold mb-4 text-foreground">Relevant Tours Packages</h3>
            ...
            <Modal open={isModalOpen} onClose={() => !isSubmitting && setIsModalOpen(false)}>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="p-3 bg-gray-50 rounded-lg text-sm border border-border">
                        ...
                        <p><strong>Date:</strong> {selectedDate ? formatDateForDisplay(selectedDate) : 'Not selected'}
                        </p>
