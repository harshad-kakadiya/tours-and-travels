  ...
  const testimonials = [
    {
      ...
      location: "Mumbai",
      rating: 5,
      text: `WanderWise Tours made our Kerala backwaters trip absolutely magical! The houseboat experience was beyond our expectations, and the local guide shared fascinating stories about the region. Every detail was perfectly planned, from airport pickup to the farewell dinner. We felt like VIP guests throughout our journey.`,
    ...
    },
    {
      ...
      location: "Delhi",
      rating: 5,
      text: `Our Rajasthan heritage tour was a dream come true! The palace hotels were stunning, and the desert safari under the stars was unforgettable. The team's attention to detail and local connections made all the difference. My family is already planning our next adventure with WanderWise.`,
    ...
    },
    {
      ...
      location: "Ahmedabad",
      rating: 5,
      text: `The Himalayan trek was challenging but incredibly rewarding! Our guide was knowledgeable and ensured our safety throughout. The mountain views were breathtaking, and the local cuisine was delicious. WanderWise exceeded our expectations in every way possible.`,
    ...
    },
    {
      ...
      location: "Bangalore",
      rating: 5,
      text: `Goa with WanderWise was perfect for our anniversary! The beachfront resort was luxurious, and the sunset cruise was romantic. The team arranged special touches that made our celebration memorable. Professional service with a personal touch - highly recommended!`,
  ...
  const trustBadges = [
    {
      ...
      description: "Approved Tour Operator",
      icon: "Award",
      color: "text-accent"
    },
    {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-card rounded-2xl shadow-brand-soft p-8 h-full">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-2xl shadow-brand-soft p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Destinations Covered</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {trustBadges?.map((badge, index) => (
            ...
            >
              <div className={`w-12 h-12 mx-auto mb-3 bg-muted rounded-full flex items-center justify-center ${badge?.color}`}>
