                ...
                >
                    {/* Tooltip */}
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="relative w-16 h-16 bg-[#256ba2] hover:bg-[#1a4f7a] rounded-full shadow-brand-large flex items-center justify-center text-white transition-all duration-300 group"
                        ...
                        >
                            ...
                            {/* Phone Icon */}
                            <Icon name="Phone" size={28} color="white" strokeWidth={3} />
                        ...
                        >
                            <div className="space-y-3">
                                <button
                                    onClick={handleCallClick}
                                    className="flex items-center space-x-3 w-full text-left p-2 rounded-lg hover:bg-gray-100 transition-colors"
                                >
                                    <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                                        <Icon name="Phone" size={16} color="#256ba2" />
                                    </div>
                                    <div>
                                        <div className="text-sm font-medium text-gray-800">Call Now</div>
                                        <div className="text-xs text-gray-600">+91 97258 55858</div>
                                    </div>
                                </button>
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="text-sm font-medium text-gray-800">Call</div>
                                ...
                                >
                                    <div className="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center">
                                        <Icon name="Mail" size={16} color="#DC2626" />
                                    </div>
                                    <div>
                                        <div className="text-sm font-medium text-gray-800">Email</div>
                                        <div className="text-xs text-gray-600">Send inquiry</div>
                                    </div>
                                </button>
                            </div>
                        </motion.div>
